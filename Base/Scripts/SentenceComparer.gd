...
func compare(sentence:String) -> String:
	...
	if sentence != "":
		...
		if sentence.containsn("interpreter") || sentence.containsn("don't understand") || sentence.containsn("not understand") || sentence.containsn("no understand") || sentence.containsn("don't know") || sentence.containsn("not know"):
